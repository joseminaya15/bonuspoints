            ...
            <div class="js-fondo menu"></div>
                <div class="js-container" style="margin-top: 100px;">
                    ...
                    <div class="jm-container--cards">
                        <div id="Bill" class="jm-card jm-card-menu" onclick="goToMenu(this.id)">
                        ...
                        <div id="Score" class="jm-card jm-card-menu" onclick="goToMenu(this.id)">
                            <div class="jm-card__title">
                                <img src="<?php echo RUTA_IMG?>menu/puntajes.png">
                            </div>
                            <div class="jm-card__supporting-text">
                                <p>Mis Puntajes</p>
                            </div>
                        </div>
                        <div id="Award" class="jm-card jm-card-menu" onclick="goToMenu(this.id)">
                            <div class="jm-card__title">
                        ...
                        <div id="Ranking" class="jm-card jm-card-menu" onclick="goToMenu(this.id)" style="opacity: .5; pointer-events: none;">
                            <div class="jm-card__title">
