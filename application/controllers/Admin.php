...
class Admin extends CI_Controller {
	...
	public function index(){
        ...
        //             $estado    = 'Rechazado';
        //         }
        //         if($key->alertas == 1 || $key->flag_status == 2 || $key->flag_status == 3){
        //             $disabled2 = 'disabled';
        //         }else {
        //             $disabled2 = '';
        //         }
        //         $html .= '<tr>
        //                       <td class="text-left">'.$key->bill_number.'</td>
        //                       <td class="text-left">'.$key->part_number.'</td>
        //                       <td class="text-left">'.$key->description.'</td>
        //                       <td class="text-left">'.$key->score.'</td>
        //                       <td class="text-center">'.$key->bill_date.'</td>
        //                       <td class="text-left">'.$estado.'</td>
        //                       <td class="text-center">'.$key->register_date.'</td>
